 ...
 *
 * @note Zmiany pliku naglowkowego nie powinny byc konieczne, prosze probowac zmienic jedynie w pliku zrodlowym PtrCStringVector.cpp,
 *       metody pomocnicze, ktore mozna wykorzystac juz sa zadeklarowane
 *
...
public:
     ...
     *  @exception jezeli index jest poza zakresem zwraca pusty tekst "" **/
